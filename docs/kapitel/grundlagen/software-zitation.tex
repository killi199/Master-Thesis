...
In dieser Arbeit wird verstärkt auf das Prinzip der Wichtigkeit eingegangen, da besonders im \gls{cff}- und \hologo{BibTeX}-Format die Möglichkeit besteht, nicht die Software, sondern beispielsweise einen Artikel anzugeben.
...
Einige dieser Quellen werden in der Masterarbeit untersucht, wie beispielsweise das \gls{cff}- und \hologo{BibTeX}-Format.
...
Es gibt ebenfalls bereits Projekte, welche sich für die halb-automatische Nennung von Autoren ohne Codebeitrag einsetzen.
...
Aus diesem Grund ist unter anderem die Menge der Autoren, welche in den Quellen angegeben werden, unterschiedlich und hängt von dem jeweiligen Projekt ab.
