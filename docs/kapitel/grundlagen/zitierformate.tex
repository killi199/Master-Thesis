...
% TODO auf DOI eingehen, dass die jeweils für die Software und preferred citation vorhanden ist (und das mit ins bsp bauen.) alle möglichkeiten natürlich zeigen
...
Ein weiteres Beispiel ist das Programm \textit{cffconvert}, welches das \gls{cff} in verschiedene Formate umwandeln kann, wie zum Beispiel \hologo{BibTeX} oder RIS.
