...
% TODO git settings erklären, dass email und name frei gewählt werden darf
% TODO erklären, dass GitHub die E-Mails automatisch über die E-Mails matcht, welche in GH registriert sind (Wenn zugriff über API oder im web dargestellt wird)
