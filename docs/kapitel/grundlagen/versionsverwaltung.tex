...
Aus diesem Grund und weil Git-Repositorys in dieser Arbeit untersucht werden, wird im folgenden auf Git eingegangen.
...
Bei der Benutzung von Git ist ein Server nicht zwingend erforderlich.
Dieser ermöglicht allerdings die einfache kollaborative Entwicklung von Code, da dieser ständig erreichbar ist und zentral verwaltet wird \autocite{ponuthorai_version_2022}.
