...
Aus diesem Grund und weil Git-Repositorys in der Arbeit untersucht werden, wird im folgenden auf Git eingegangen.
...
Git-Anwendungen sind Programme, welche mit dem lokal auf dem Computer befindlichen Repository interagieren \autocite{ponuthorai_version_2022}.
