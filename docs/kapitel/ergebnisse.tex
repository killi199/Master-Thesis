...
Außerdem sind in den beiden Quellen jeweils die meisten TN vorhanden.
...
Hier werden insgesamt nur vier Autoren betrachtet, zusätzlich ist der F1-Score mit 0,6667 am schlechtesten für diese Quelle.
...
\begin{table}
    \begin{tabularx}{\textwidth}{XR{.8cm}R{.8cm}R{.8cm}R{.8cm}R{2.8cm}R{2cm}}
        ...
        \hologo{BibTeX}              & 2    & 2  & 0   & 0   & 0   & 0,6667 \\ \midrule
        Summe                        & 1357 & 61 & 109 & 436 & 195 & 0,9411 \\
        \bottomrule
    \end{tabularx}
