...
In \autoref{fig:citation_counts_preferred_citation_cff} ist auffällig, dass ein \gls{cran} Paket aus der \gls{cran} \gls{cff} Liste als Typ der Zitation \emph{article} angegeben hat.
...
% Auf Auffälligkeiten eingehen und die anekdotisch untermauern
\begin{figure}
    \begin{subfigure}{.5\textwidth}
        \centering
