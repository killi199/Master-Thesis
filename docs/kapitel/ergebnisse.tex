...
% TODO anekdotisch ausreißer beschreiben
...
% TODO dabei darauf eingehen, dass erneut ein Namensabgleich zwischen den autoren gemacht wird (aber nur über den Namen) in einer Quelle aber nur falls der Abgleich in der Datenbeschaffung nicht erfolgreich war -> Das führt jedoch wieder dazu, dass autoren die nicht abgeglichen werden konnten und dann eine andere Schreibweise in dem Namen verwenden hier als "Neue" Autoren gelistet werden und die vorherige Schreibweise dann als entfernter Autor betrachtet wird
...
% TODO die Tabelle ähnlich beschreiben wie tab:average_time_last_update
\begin{table}
    \centering
    \setlength{\tabcolsep}{8pt}
    \begin{tabular}{c|c|c|c|c|c}
