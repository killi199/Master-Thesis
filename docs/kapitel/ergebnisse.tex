...
\begin{figure}
    ...
    \small
    % TODO Nicht zentrieren sondern linksbündig und das für alle Bildunterschriften
...
\begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
        ...
        \caption{\hologo{BibTeX}}
        \label{fig:citation_counts_full_bib}
    \end{subfigure}
