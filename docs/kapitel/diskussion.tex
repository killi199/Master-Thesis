...
Dies liegt daran, dass die \gls{ner} viele Ergebnisse liefert, unter anderem FP, welche anschließend primär falsch zugeordnet werden.
Ebenfalls sind viele falsch negative Ergebnisse enthalten, da die \gls{ner} ebenfalls Benutzernamen erkennt, wie bereits erläutert wurde.
Außerdem ist aufgefallen, dass viele TN in den Ergebnissen enthalten sind.
...
Außerdem ist Aufgefallen, dass insgesamt viele FP in den Ergebnissen enthalten sind.
