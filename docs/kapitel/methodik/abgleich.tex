...
% TODO auf Score eingehen, dass der noch immer beim abgleich zuzüglich zu den Git Daten hinzugefügt wird
% thefuzz==0.22.1
% TODO sagen welche daten aus dem Abgleich entstehen (rank, insertions, deletions, lines_changed, files, commits, first_commit, last_commit, score)
% TODO auf score eingehen!
