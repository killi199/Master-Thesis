...
Eine extrahierte Information, welche in beiden Dateien, also der \path{cff.csv} und \path{cff_preferred_citation.csv} gespeichert wird, ist die DOI aus dem \gls{cff} Feld \glqq identifiers\grqq{}.
