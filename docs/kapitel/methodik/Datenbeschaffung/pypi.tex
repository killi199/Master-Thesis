...
Anschließend werden die Daten in den Dateien \texttt{python\_authors.csv} und \texttt{python\_maintainers.csv} gespeichert.
...
Dabei wird das Programm so verwendet, dass nur die Entitäten \texttt{PERSON} extrahiert werden.
...
Die extrahierten Autoren werden ebenfalls mit den Git Daten abgeglichen und in der Datei \texttt{description\_authors.csv} gespeichert.
...
Die Daten werden nachdem sie mit den Git Daten abgeglichen wurden in der Datei \texttt{pypi\_maintainers.csv} gespeichert.
