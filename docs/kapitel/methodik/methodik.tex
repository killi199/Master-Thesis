\chapter{Methodik}
\label{chap:methodik}
% TODO hier auf mich selbst referenzieren (Der entwickelte Quellcode ist in einem Gitea-Repository verfügbar (Jahrens 2024))
...
\begin{figure}
    ...
    \dirtree{%
        ...
        .2 \path{20210819_161452-0400_bib_authors_new.csv}\DTcomment{\hologo{BibTeX} Autoren abgeglichen mit den Git Werten zum neusten Zeitpunkt}.
        ...
        .2 \path{20221010_124020-0400_readme_authors_new.csv}\DTcomment{Autoren in der Beschreibung abgeglichen mit den Git Werten zum neusten Zeitpunkt}.
        .2 \path{20221010_124020-0400_git_contributors.csv}\DTcomment{Git Autoren bis zu diesem Zeitpunkt}.
        .2 \path{bib.csv}\DTcomment{Allgemeine informationen zur \hologo{BibTeX}-Datei zu allen Zeitpunkten z. B. eingetragene \gls{doi}}.
        .2 \path{readme.csv}\DTcomment{Allgemeine Informationen zur Beschreibung}.
        .2 \path{git_contributors.csv}\DTcomment{Git Autoren zum neusten Zeitpunkt}.
