...
\begin{figure}[H]
    \begin{subfigure}{.5\textwidth}
        \centering
        \includesvg[width=.95\linewidth,inkscapelatex=false]{bilder/similarity/similarity_with_non_matches_pypi.svg}
        \caption{\gls{pypi} inklusive nicht abgeglichener Autoren}
        \label{fig:similarity_with_non_matches_pypi}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includesvg[width=.95\linewidth,inkscapelatex=false]{bilder/similarity/similarity_without_non_matches_pypi.svg}
        \caption{\gls{pypi} exklusive nicht abgeglichener Autoren}
        \label{fig:similarity_without_non_matches_pypi}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includesvg[width=.95\linewidth,inkscapelatex=false]{bilder/similarity/similarity_with_non_matches_cran.svg}
        \caption{\gls{cran} inklusive nicht abgeglichener Autoren}
        \label{fig:similarity_with_non_matches_cran}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includesvg[width=.95\linewidth,inkscapelatex=false]{bilder/similarity/similarity_without_non_matches_cran.svg}
        \caption{\gls{cran} exklusive nicht abgeglichener Autoren}
        \label{fig:similarity_without_non_matches_cran}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includesvg[width=.95\linewidth,inkscapelatex=false]{bilder/similarity/similarity_with_non_matches_cff.svg}
        \caption{\gls{cff} inklusive nicht abgeglichener Autoren}
        \label{fig:similarity_with_non_matches_cff}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includesvg[width=.95\linewidth,inkscapelatex=false]{bilder/similarity/similarity_without_non_matches_cff.svg}
        \caption{\gls{cff} exklusive nicht abgeglichener Autoren}
        \label{fig:similarity_without_non_matches_cff}
    \end{subfigure}
