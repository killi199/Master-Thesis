...
%\begin{table}
%    \begin{tabularx}{\textwidth}{XR{3cm}R{4.2cm}R{3cm}}
%        \toprule
%        \textbf{SHIP-Welle} & \textbf{MDM-Portal} & \textbf{Datenverzeichnis} & \textbf{Schnittmenge} \\
%        \midrule

%        START-0 & 105  & 3423 & 41    \\
%        START-1 & 84   & 2402 & 33    \\
%        START-2 & 630  & 8513 & 147   \\
%        TREND-0 & 3284 & 10026 & 2672 \\
%        START-3 & 2660 & 5544 & 2506  \\
%        TREND-1 & 4796 & 7323 & 4241  \\
%        START-4 & 0    & 3942 & 0     \\
%        \bottomrule
%    \end{tabularx}
%            \caption{Die Anzahl der Formularfelder bzw. Datenerhebungspunkte für das Medical Data Models Portal (MDM-Portal) und das Datenverzeichnis der Universität Greifswald für jede SHIP-Welle. Zudem wird die Schnittmenge, d.h. die Anzahl der Formularfelder mit identischer ID, zwischen den beiden Datenquellen für jede SHIP-Welle angezeigt.} 
%        \label{t:dataset_questions_count_intersection}
%\end{table}
